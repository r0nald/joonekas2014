...
/**
  * @brief 64 entries of sine in 16.16 fixed point format.
  *        Angles from 0 (including) to 90 (not including) degrees
  */
static const uint16_t SineLookup[] =
{
...
/**
  * @brief  Calculation of sine in 16.16 fixed point format.
  * @param  Angle: 16.16 fixed point format representing factor
  *         of full circle (0 = 0 degrees, 1 = 360 degrees)
  * @retval Sine in 16.16 fixed point of format (0 to 1)
  */
fixed Sin(fixed Angle)
{
    ...
    //
    // If bit 7 is set, the angle is between 90 and 180 or 270 and 360.  In
